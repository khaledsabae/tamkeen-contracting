...
export const en: Dict = {
  ...
  chapters: [
    { n: '01', kicker: 'The Beginning', title: 'Building today for a stronger tomorrow', en: 'BUILDING TODAY FOR A STRONGER TOMORROW', body: 'From the first line on the ground, a journey begins where vision turns into reality.', align: 'right' },
    { n: '02', kicker: 'Engineering', title: 'Turning vision into an executable plan', en: 'VISION ENGINEERED INTO REALITY', body: 'Engineering coordination and a digital vision place execution at the heart of every decision.', align: 'right' },
    { n: '03', kicker: 'Execution', title: 'From foundation to delivery', en: 'FROM FOUNDATION TO DELIVERY', body: 'Disciplined execution unites site, engineering and quality in one path.', align: 'right' },
    { n: '04', kicker: 'Systems', title: 'Engineering behind every achievement', en: 'SYSTEMS BEHIND EVERY STRUCTURE', body: 'Integrated MEP solutions coordinated with the building — not added to it later.', align: 'engineered' },
    { n: '05', kicker: 'Capabilities', title: 'Integrated project solutions', en: 'INTEGRATED PROJECT CAPABILITIES', body: 'Buildings, infrastructure, facilities and engineering systems within one executive vision.', align: 'center' },
    { n: '06', kicker: 'Outcome', title: 'From vision to reality', en: 'FROM VISION TO REALITY', body: 'The end of the journey is not only a building, but an asset designed and built to endure.', align: 'center' },
  ],
  ...
  portfolio: {
    ...
    heading: 'Projects to be added',
    heading2: 'after approval',
    demoNote: 'Reserved spaces for actual TAMKEEN projects — no completed projects shown before their official data is supplied.',
    aria: 'Projects (placeholders)',
    placeholder: 'PLACEHOLDER — AWAITING OFFICIAL DATA',
    plates: [
      { title: 'Demo project — Buildings', tag: 'RESIDENTIAL / MIXED-USE' },
      { title: 'Demo project — Infrastructure', tag: 'INFRASTRUCTURE' },
      { title: 'Demo project — Facilities', tag: 'FACILITIES' },
    ],
  },
  contact: {
